...
public final class Vector2 {
    ...
    public static final Vector2 UNIT_Y =
            new Vector2(0.0, 1.0);
    ...
    public int hashCode() {
        return Objects.hash(
                Math.round(
                        x / MathConstants.EPSILON
                ),
                Math.round(
                        y / MathConstants.EPSILON
                )
        );
    }
